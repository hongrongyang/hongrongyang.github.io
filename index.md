...
I am broadly interested in the **learning-based control** for **energy systems**. My **previous research** focused on the deep reinforcement learning algorithms, with applications to EV fleets management and individual EV battery management system. The relevant papers could be found in [Publications page](https://hongrongyang.github.io/Publications). 
