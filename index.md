...
1. Design the safe and distributed learning-based control methods for the complex and large systems, with the ultimate goal of obtaining a better understanding of collective intelligence.​
...
3. Investigate how to charge the EV batteries safely (avoid the battery lithium precipitation), quickly (allocate the charging energy for charging & heating) and environmental friendly (reduce the energy consumption) in cold environments.
